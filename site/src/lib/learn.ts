...
const UI_EN = {
  ...
  note: "Built on NSPCC Talk PANTS, Darkness to Light's five steps, Arpan's personal-safety work, Stop It Now, Kidpower and WHO INSPIRE. Educational information, not professional advice.",
...
const UI_TA: UI = {
  ...
  note: 'NSPCC Talk PANTS, Darkness to Light-இன் ஐந்து படிகள், Arpan-இன் தனிப்பட்ட பாதுகாப்புப் பணி, Stop It Now, Kidpower, WHO INSPIRE ஆகியவற்றின் அடிப்படையில். இது கல்வித் தகவல், தொழில்முறை ஆலோசனை அல்ல.',
